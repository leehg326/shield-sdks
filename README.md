...
| Java | [shield-java](https://github.com/shieldapi/shield-sdks/tree/main/java) | `implementation 'dev.getshield:shield-java:0.1.6'` | [![Maven](https://img.shields.io/maven-central/v/dev.getshield/shield-java)](https://search.maven.org/artifact/dev.getshield/shield-java) |
